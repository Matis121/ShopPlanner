...
const List = () => {
  ...
  return (
    ...
    >
      <section className="relative flex top-0 flex-col w-[600px] h-full min-h-screen pt-12 pb-20 md:pb-8 px-4 rounded-md border dark:border-neutral-800 bg-white dark:bg-neutral-950 md:min-h-full md:h-full md:my-16 md:px-8">
        <X
          size={30}
